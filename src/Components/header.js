export default function Header(){
    return`
        ...
        <nav>
            <ul class="conteiner1">
                <li class="logo"><a href="#"  data-rota="home"><img class="whale-logo link" src="src/Images/logo.jpg" width="50px" height="50px" alt="WhaleQuiz"></a></li>
                <li class="criar">
                ...
                <li class="entrar">
                    <a href="#" data-rota ="login">Entrar</a>
                </li>
                <li class="registrar">
